...
/*/
$suggestion1 = dbQuery("SELECT id,image_med,title,author,release_year,length,summary,description FROM suggestions WHERE category='{category}' ORDER BY rand() LIMIT 1");
